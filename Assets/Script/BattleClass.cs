...
public class BattleClass : MonoBehaviour
{
    ...
    public ClasseBase goblin = new Goblin(100,100, 10, 1);
    ...
    private void Awake()
    {
        ...
        turnoPlayer = true;//DEIXA O TURNO DO PLAYER ATIVO, CASO COMEÇA COM O PLAYER O RAUND
    ...
    {
        Mensagem.Mensagens = "TURNO DO PLAYER";
        opcao = op;
        ...
        if (turnoPlayer == true)
        {
            ...
            if (opcao == 1)
            {
                ...
                turnoPlayer = false;//DEIXA O TURNO DO PLAYER DESATIVADO
                Passarturno.SetActive(true);//CANVAS ATIVA, ASSIM O PLAYER N PODE USAR OS BOTÕES 
            }
            if (opcao == 2)//DEFESA
            {
                ...
                turnoPlayer = false;//PASSA PARA O TURNO DO INIMIGO
                Passarturno.SetActive(true);//ATIVA O CANVAS PARA O PLAYER N PODER USAR
            }
            if (opcao == 3)//ESPECIAL NORMAL
            {
                ...
                turnoPlayer = false;//TERMINA O TURNO DO PLAYER E PASSA PARA O INIMIGO
                Passarturno.SetActive(true);//ATIVA O CANVAS PARA O PLAYER N PODER USAR OS BOTÕES 
            }
            if (opcao == 4)
            {
